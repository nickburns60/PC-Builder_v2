...
//            }
            ...
            if(menuChoice.equals("1")){
                ...
                System.out.println("You have chosen to build a new pc. We will provide you with a list of options for each part needed for your build.\n " +
                        "To select a part, simply type the corresponding number and press enter");
                //processor selection
